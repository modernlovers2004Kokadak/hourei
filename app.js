...
function renderHome(){
  ...
  app.innerHTML=`<section class="home-card progress-card">
    ...
    <div class="section-title-row"><h2 class="section-title">筆記試験科目</h2><a class="exam-guide-link" href="./preview.html?v=4.0.63">新制度による筆記試験実施要領</a></div>
...
async function registerCurrentServiceWorker(){
  ...
  try{
    ...
    const registration=await navigator.serviceWorker.register('./sw.js?v=4.0.63',{updateViaCache:'none'});
